...
const Herosec = () => {
  return (
    <div>
      ...
      <div className='w-[1280px] h-[584px] mt-[60px] ml-[80px] bg-[#2A254B] shadow-xl cursor-pointer ' >
...
<div className='w-[1420px] h-[761px] '>
    <div className='w-[217px] h-[39px] mt-[-490px] ml-[80px] '>
        <p className='font-normal text-[32px] leading-[39.36]  hover:scale-125 duration-1000'>New ceramics</p>
    </div>
</div>


<div className='grid sm:grid-cols-1 md:grid-cols-2 py-[20px] lg:grid-cols-3 xl:grid-cols-4 gap-3 '>
<div className='w-[305px] h-[462px] mt-[-70px] ml-[80px] gap-[24px]  shadow-lg rounded-md '>
  <div className='overflow-hidden duration-1000'>  <Image className='hover:scale-125' src={Parent} width={305} height={375} alt='Parent'></Image></div>
    <div className='w-[156px] h-[63px]  mt-5 gap-[8px]'> <h4 className='font-normal text-[20px] leading-[28px] '>The Dandy chair </h4>
    <div className='w-[44px] h-[26px] mt-3'><p className='font-normal text-[18px] hover:text-lg '>£250</p></div>
    </div>
</div>

<div className='w-[305px] h-[462px] mt-[-70px] ml-[50px] gap-[24px]  shadow-lg rounded-md'>
...
<div className='w-[305] h-[462px] mt-[-70px] ml-[20px] gap-[24px]  shadow-lg rounded-md'>
<div className='overflow-hidden duration-000'><Image className='hover:scale-125' src={Three} width={305} height={375} alt='Parent2'></Image></div>
...
<div className='w-[305px] h-[462px] mt-[-70px]  gap-[24px] shadow-lg rounded-md '>
<div className='overflow-hidden duration-000'> <Image className='hover:scale-125' src={Four} width={305} height={375} alt='Parent2'></Image></div>
<div className='w-[156px] h-[63px]  mt-5 gap-[8px]'> <h4 className='font-normal text-[20px] leading-[28px]'>The Lucy Lamp </h4>
    <div className='w-[44px] h-[26px] mt-3'><p className='font-normal text-[18px] '>£399</p></div>
    </div>
</div>
...
<div className='w-[1440px] h-[761px] '>
    <div className='w-[330px] h-[45px] mt-[65px] ml-[80px] hover:scale-125 duration-1000 '>
        <h2 className='font-normal text-[32px] leading-[44.8px]'>Our popular products</h2>
    </div>
</div>
<div className='flex  mt-[-620px] ml-40  '>
<div className='w-[630px] h-[462px] mt-[-70px] ml-[-100px] gap-[24px] shadow-lg rounded-md'>
<div className='overflow-hidden duration-1000'>  <Image className='hover:scale-125' src={Large} width={630} height={375} alt='Parent2'></Image></div>
    <div className='w-[156px] h-[63px]  mt-5 gap-[8px]'> <h4 className='font-normal text-[20px] leading-[28px]'>Rustic Vase Set </h4>
    <div className='w-[44px] h-[26px] mt-3'><p className='font-normal text-[18px] '>£980</p></div>
    </div>
</div>

<div className='w-[305px] h-[462px] mt-[-70px] ml-[10px] gap-[24px] shadow-lg rounded-md'>
...
<div className='w-[305] h-[462px] mt-[-70px] ml-[10px]  gap-[24px] shadow-lg rounded-md'>
<div className='overflow-hidden duration-1000'>  <Image className='hover:scale-125' src={Chair} width={305} height={375} alt='Parent2'></Image></div>
<div className='w-[156px] h-[63px]  mt-5 gap-[8px]'> <h4 className='font-normal text-[20px] leading-[28px]'>The Dandy chair </h4>
    <div className='w-[44px] h-[26px] mt-3'><p className='font-normal text-[18px] '>£250</p></div>
    </div>
...
<div className='w-[571px] h-[114] mt-[68px] ml-[451px] gap-4 bg-[#ffffff] hover:scale-125 overflow-hidden duration-1000'>
...
<div className='w-[720px] h-[603px]  bg-[#ffffff]'>
   <div className='mt-[210px] ml-14'>
        <p className='  w-[514px] h-[68px] font-normal text-[24px] leading-[33.6px] text-[#2A254B]  hover:scale-125 overflow-hidden duration-1000 '>From a studio in London to a global brand with
        over 400 outlets</p>
        </div>

        <div className='w-[516px] h-[132px] mt-[50px] ml-14  hover:scale-125 overflow-hidden duration-1000'>
        ...
        <div className='w-[720px] h-[603px] mt-[-350px] ml-[700px]   overflow-hidden duration-1000'>
    <Image className='hover:scale-125' src={Image1} width={720} height={603} alt='image'></Image>
</div>
    </div>
